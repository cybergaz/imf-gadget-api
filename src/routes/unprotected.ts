...
router.patch('/gadgets/:id', patchGadget)
...
export const unprotectedDocs = {
    '/unprotected/api/gadgets': {
        get: {
            summary: '[Unprotected Route] Retrieve a list of gadgets',
            ...
            tags: ['Unprotected Routes - if issues with Authentication'],
            parameters: [
                {
                    name: 'status',
                    in: 'query',
        ...
        post: {
            summary: '[Unprotected Route] Add a new gadget',
    ...
    '/unprotected/api/gadgets/{id}': {
        patch: {
            summary: '[Unprotected Route] Update a gadget',
        ...
        delete: {
            summary: '[Unprotected Route] Decommission a gadget',
    ...
    '/unprotected/api/gadgets/{id}/self-destruct': {
        post: {
            summary: '[Unprotected Route] Trigger self-destruct sequence',
